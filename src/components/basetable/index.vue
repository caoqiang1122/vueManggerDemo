<template>
  <div class="basetable" v-loading="loading" element-loading-text="拼命加载中">
    <div class="selectMenu">
      <el-date-picker v-model="value6" placeholder="选择日期范围" type="daterange">
      </el-date-picker>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="性别" prop="region"></el-table-column>
    ...
    <div class="page">
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="currentPage3" :page-size="10" layout="prev, pager, next, jumper" :total="100">
      </el-pagination>
    </div>
